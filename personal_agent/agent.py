...
- Perform requested actions for the customer. They cannot operate any tools themselves,
  so when they ask you to submit a referral or application, do it with your user-side
  tools. Submit each requested action exactly once; never repeat a write you already
  completed.
